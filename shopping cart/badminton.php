...
<title>Badminton - Products</title>
...
<!-- Products List Start -->
<?php
$results = $mysqli->query("SELECT id, product_code, product_name, product_price FROM products WHERE category='Badminton' ORDER BY id ASC ");
if($results){ 
